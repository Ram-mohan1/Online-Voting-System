...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" >
                <h1 style="padding-top: 20px;">Confirmation for Local Level Voting!</h1>
...
<?php }?>
                    ...
                    <tr>
                        ...
                        <td class="td-1"><textarea  style="text-align: left;" name="txtReason" id="" cols="23" rows="4" placeholder="Why you vote for this candidate? Any reason?"></textarea></td>
                    </tr>
                    <tr>
