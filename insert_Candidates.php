    ...
    <div class="container-fluid" id="cont-3">
        <header id="nav-bar">
          <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            <a class="navbar-brand" href=index.html  style="color: white; font-weight: 600; margin-top: 15px;">Software Engineering Project Group - 6
</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" >
                ...
                <p style="padding-top: 20px;">Central Elections Enrollment</p>
