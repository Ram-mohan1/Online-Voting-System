...
<head>
    ...
    <title>Local Candidate Confirmation</title>
    ...
    <div class="container-fluid" id="cont-3">
        <header id="nav-bar">
          <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            <a class="navbar-brand" href=index.html  style="color: white; font-weight: 600; margin-top: 15px;">Software Engineering Project Group - 6</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" >
                ...
                <p style="padding-top: 20px;">Local Ward Elections</p>
                ...
                <table>
                    ...
                    <tr>
                        <td class="td-1">Party :</td>
                        <td><select name="txtbranch">
                          
                        <option>Janasena Party</option>
                        <option>YSR Congress Party</option>
                        <option>Bharatiya Janatha Party</option>
                        <option>Telugu Desham Party</option>
                          
                        </select></td>
                    </tr>
                    <tr>
                        <td class="td-1">Aadhar No. :</td>
                        <td class="td-1"><input required  type="number" style="text-align: left;" name="txtAdNo"></td>
                    </tr>
                    <tr>
