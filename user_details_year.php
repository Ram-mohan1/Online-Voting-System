...
<div class="container-fluid" id="cont-3">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <a href="user_deatils.php"><button style="margin-top:80px;" class="btn-special-2">Central Level Elections</button></a>
            </div>
            <div class="col-md-12">
            <a href="user_details_2.php"><button style="margin-top:80px;" class="btn-special-2">State Level Elections</button></a>
            </div>
            <div class="col-md-12">
            <a href="user_details_3.php"><button style="margin-top:80px; " class="btn-special-2">Local Level Elections</button></a>
            </div>
        </div>
    </div>
