...
<section>
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4" style="border-radius: 6px; border: 3px  #c70035 dashed;">
          <h2 style="padding-top: 30px; font-size:50px;">Contact Form</h2>
        ...
        <div class="col-md-8" style="padding-left: 50px; width: 100%; padding-top: 30px;">
          <img src="img/contact.svg" alt="" srcset="">
        </div>
      </div>
    </div>
  </section>
